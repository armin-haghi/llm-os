...
8. `orchestration/README.md` when refreshing projects, selecting queued work, auditing readiness, or coordinating cross-interface agent runs
...
4. `orchestration/prompts/project-audit.md` for project readiness audits
